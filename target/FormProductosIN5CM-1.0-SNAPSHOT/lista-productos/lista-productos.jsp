...
<%@page import="org.josemorejon.webapp.model.Producto"%>
...
<html>
    <head>
        ...
        <style>
            .bg-custom {
                background-image: url('https://img.freepik.com/vector-premium/diamantes-rojos-sobre-fondo-rojo-claro_197792-690.jpg');
